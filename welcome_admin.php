...
<div class="row">
      <div class="col-2" style="font-family: amita;font-size:20px"><a href="contactus_data.php"><i class="fas fa-phone" style="font-size:30px"></i> Contact-us Data</a>
        </div>
                     ...
                     <thead>   <td><b>Id</b></td>
                      ...
                      while($row=mysqli_fetch_array($result)){
                         ...
                         <td><img src="<?php echo $row['image'] ?>"
                          ...
                          <td><a href="update.php?id=<?php echo $row["id"]; ?>"title='Edit Record'><i class="fas fa-edit"></i></a></td>
